...
function enableEraser(ev){
    ...
    ev.target.style.color = !states.eraserEnabled ? "black" : "red";
...
function togglePickColor(ev){
    ...
    ev.target.style.color = states.enablePickColor ? "red" : "black";
}
useEffect(()=>{
...
function toggleFillColor(ev){
    ...
    ev.target.style.color = !states.enableFillColor ? "black" : "red";
 ...
 return (
    <div className="navbar rounded-b top-bar shadow-lg border-b border-black" style={{
        ...
        <button className='circular'><i className='paint brush icon'></i></button>
        ...
        <button className='circular' onClick={importModel}><i className="download icon"></i></button>
        <button className='circular' onClick={downloadModel}><i className="upload icon"></i></button>
        </div>
        <button className='circular ui button w-16 h-16 object-righ p-5'><i className='th large icon'></i></button>
    </div>
 )
}